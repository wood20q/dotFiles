...
Rectangle {
    ...
    property color boxColor: root.colBlue
    property color hoverColor: root.colCyan
    ...
    Text {
        ...
        color: button.borderSize == 0? "#000000" : (button.hovered? button.hoverColor : button.boxColor)
    }
